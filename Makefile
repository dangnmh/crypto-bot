...
EXCLUDE_EXCHANGES := (batonex|bingx|bitfinex|bitmex|bydfi|coinex|cryptocom|deribit|digifinex|dydx|hashkey|htx|ju|lbank|phemex|whitebit|woox|zoomex|krakenfutures|coinw|hyperliquid|sunx|fameex)
