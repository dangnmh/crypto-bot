...
EXCLUDE_EXCHANGES := (batonex|bingx|bitfinex|bitmex|blofin|bydfi|coinex|cryptocom|deribit|digifinex|dydx|hashkey|htx|ju|lbank|phemex|pionex|whitebit|woox|zoomex|krakenfutures|coinw|hyperliquid|sunx|fameex)
