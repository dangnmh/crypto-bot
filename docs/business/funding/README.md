...
| [obfuscator_flow.md](obfuscator_flow.md) | Order Obfuscator: Anti-surveillance loss budget execution | Implemented |
...
| Order Obfuscator | Implemented | Background Loss Budget Scanner | Background cron | [obfuscator_flow.md](obfuscator_flow.md) |
