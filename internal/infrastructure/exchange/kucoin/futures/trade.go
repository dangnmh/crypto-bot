...
func (c *Client) rawSwitchMarginMode(ctx context.Context, req kucoinSwitchMarginModeRequest) error {
	...
	body, err := c.base.Request(ctx, http.MethodPost, "/api/v2/position/changeMarginMode", nil, bodyBytes, true)
	if err != nil {
		return err
	}
	return kucoin.ParseResponseIgnoreData(body, "changeMarginMode")
}
