...
import (
	...
	kucoin "crypto-bot/internal/infrastructure/exchange/kucoin/futures"
	...
	mexc "crypto-bot/internal/infrastructure/exchange/mexc/futures"
	...
	toobit "crypto-bot/internal/infrastructure/exchange/toobit/futures"
...
func BuildPublicClient(ctx context.Context, exchangeName string, httpClient *http.Client, logger *slog.Logger, logCfg sysconfig.LoggingConfig) (any, error) {
	...
	case "sunx":
		return sunx.NewClient(httpClient, "https://api.sunx.io", logCfg), nil
	case exchange.ExchangeTrubit:
		return trubit.NewClient(httpClient, "https://api-futures.trubit.com", logCfg), nil
