...
func (r *StatelessRunner) dispatchOrderManagerIntent(
	...
	orderIntent := futures.OrderIntentEvent{
		...
		SkipPreFlight:           true,
		EnablePnLTrailing:       cand.Config.FundingReversion.EnablePnLTrailing,
		PnLTrailingDropPct:      cand.Config.FundingReversion.PnLTrailingDropPct,
		PnLTrailingConfirmTicks: cand.Config.FundingReversion.PnLTrailingConfirmTicks,
