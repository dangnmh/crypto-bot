...
//go:generate go run go.uber.org/mock/mockgen@v0.6.0 -destination mock_notifier.go -package mocks -typed crypto-bot/internal/infrastructure/notifier Notifier
